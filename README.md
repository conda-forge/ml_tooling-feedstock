About ml_tooling-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ml_tooling-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6323&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ml_tooling-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ml_tooling` can be installed with `conda`:
...
```
mamba install ml_tooling
```

It is possible to list all of the versions of `ml_tooling` available on your platform with `conda`:
...
```
mamba search ml_tooling --channel conda-forge
```
...
mamba repoquery search ml_tooling --channel conda-forge

# List packages depending on `ml_tooling`:
mamba repoquery whoneeds ml_tooling --channel conda-forge

# List dependencies of `ml_tooling`:
mamba repoquery depends ml_tooling --channel conda-forge
```
